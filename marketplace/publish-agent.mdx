...
<ParamField path="monetization" type="string" required>
  One of `per_call`, `subscription`, `hybrid`, `freemium`. See [Monetization Models](/marketplace/monetization-models).
</ParamField>
...
Tool prices stack on top of the base per-call price and are settled under the [Tool Premium](/marketplace/earnings-split#tool-premium) bucket.
