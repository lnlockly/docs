...
If you need full control over the runtime — model selection, custom tools, on-prem data — see [Self-Host](/self-host/architecture). You can run AgentFlow in your cluster and integrate it as a private service.
