...
<Info>
  **Who this is for:** anyone with a working agent who wants to monetize it.
  **What you need:** an existing agent in your account, a price model in mind, optionally a Launchpad token to attach.
  **Time:** about 15 minutes if your agent is ready.
</Info>
...
<Steps titleSize="h3">
  ...
  <Step title="Pick a monetization model">
    See [Monetization Models](/en/marketplace/monetization-models) for the four options. Heuristic:
...
Per the [Earnings Split](/en/marketplace/earnings-split):
...
<CardGroup cols={2}>
  <Card title="Earn $FLOW as a creator" icon="hand-coins" href="/en/guides/earn-flow-as-creator">
    Stack creator income across multiple agents.
  </Card>
  <Card title="Withdraw earnings" icon="wallet" href="/en/flow/payouts">
    Move $FLOW to your wallet.
  </Card>
  <Card title="Earnings split" icon="chart-pie" href="/en/marketplace/earnings-split">
    Exactly how each call's $FLOW gets divided.
  </Card>
</CardGroup>
