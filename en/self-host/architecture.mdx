...
<CardGroup cols={2}>
  <Card title="Kubernetes manifests" icon="hammer" href="/en/self-host/kubernetes">
    Apply the bundled k8s/ manifests in each service repo.
  </Card>
  <Card title="Environment variables" icon="settings" href="/en/self-host/env-variables">
