...
See [Publish an Agent](/en/marketplace/publish-agent) for the full body schema.
...
Tool prices apply to **every call** that invokes the tool, regardless of monetization model. They settle under the tool-premium bucket — see [Earnings Split](/en/marketplace/earnings-split).
