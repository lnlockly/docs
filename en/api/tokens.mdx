...
Internal trading endpoint exposed through the chain indexer service. Public client uses the Cabinet UI which calls this. The endpoint validates slippage and updates the FLOW ledger.

See `/Users/a1/Code/unimax_projects/fransh/agentflow-api/src/routes/onchain.ts` for the canonical implementation if you self-host.
